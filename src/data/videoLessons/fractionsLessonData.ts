...
export const fractionsMasterclassLesson: VideoLesson = {
  ...
  chapters: [
    ...
    },
    {
      id: 'chap-4',
      chapterNumber: 4,
      title: 'The Butterfly Method: 10-Second Exam Speed Hack',
      subtitle: 'Cross-multiplication shortcut for timed exams and quick verification',
      startTime: 175,
      duration: 55,
      teacherMood: 'excited',
      teacherPose: 'cheering',
      teacherSpokenScript:
        "Now I want to share a secret weapon that my Year 6 students absolutely adore: The Butterfly Method! When you are in a timed test and need to check an answer in ten seconds, draw butterfly wings over your fractions. Wing one: cross-multiply three times five to get fifteen in the left antenna. Wing two: cross-multiply two times four to get eight in the right antenna. Now add the antennae: fifteen plus eight is twenty-three! And for the butterfly's body at the bottom, multiply four times five to get twenty. Look at that: twenty-three over twenty in a flash!",
      captions: [
        {
          id: 'c4-1',
          time: 175,
          endTime: 183,
          text: 'Here is our secret weapon: The Butterfly Method!',
          spokenText: 'Now I want to share a secret weapon that my students absolutely adore: The Butterfly Method!',
        },
        {
          id: 'c4-2',
          time: 183,
          endTime: 191,
          text: 'Draw butterfly wings crossing diagonally across the fractions.',
          spokenText: 'When you are in a timed test and need to check an answer in ten seconds, draw butterfly wings over your fractions.',
        },
        {
          id: 'c4-3',
          time: 191,
        ...
        },
        {
          ...
          time: 218,
          endTime: 230,
          text: 'Multiply bottoms for the body: 4 × 5 = 20. Instant 23/20!',
      ...
      mathFormulas: [
        ...
        '\\implies \\frac{23}{20} = 1\\frac{3}{20}',
      ],
      takeawayNote: 'The Butterfly Method cross-multiplies to automatically calculate the scaled numerators and common denominator.',
    },
    {
      id: 'chap-5',
      chapterNumber: 5,
      title: 'Multiplying Fractions: Straight Across the Highway',
      subtitle: 'Why multiplication is the easiest fraction operation of all',
      startTime: 230,
      duration: 55,
      teacherMood: 'warm',
      teacherPose: 'pointer',
      teacherSpokenScript:
        "Here is wonderful news: multiplying fractions is actually much simpler than adding them! You do NOT need any common denominators. Think of a two-lane highway driving straight forward. Top times top, bottom times bottom! If we have two thirds times four fifths, we multiply two times four to get eight, and three times five to get fifteen. Eight fifteenths! Why does this work? Because 'times' means 'of'. Two thirds OF four fifths is cutting a four-fifths rectangle into three slices and keeping two. In our area grid, that is exactly eight squares out of fifteen!",
      captions: [
        {
          id: 'c5-1',
          time: 230,
          endTime: 238,
          text: 'Multiplying fractions is the friendliest operation of all!',
          spokenText: 'Here is wonderful news: multiplying fractions is actually much simpler than adding them!',
        },
        {
          id: 'c5-2',
          time: 238,
          endTime: 246,
          text: 'You do NOT need any common denominators here.',
        ...
        },
        {
          ...
          time: 246,
          endTime: 256,
          text: 'Think of a straight highway: top × top, bottom × bottom!',
        ...
        },
        {
          ...
          time: 256,
          endTime: 266,
          text: '2/3 × 4/5: 2 × 4 = 8, and 3 × 5 = 15. Answer is 8/15!',
        ...
        },
        {
          ...
          time: 266,
          endTime: 275,
          text: 'Two-thirds OF four-fifths means a fraction of a fraction.',
        ...
        },
        {
          ...
          time: 275,
          endTime: 285,
          text: 'In our 3×5 grid, shaded overlap is 8 boxes out of 15.',
      ...
      mathFormulas: [
        ...
        '\\text{Notice: No common denominator needed for multiplication!}',
      ],
      takeawayNote: 'Multiply straight across: Numerator × Numerator over Denominator × Denominator.',
    },
    {
      id: 'chap-6',
      chapterNumber: 6,
